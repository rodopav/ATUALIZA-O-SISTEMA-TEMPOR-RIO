...
export function ConciliarModal({
  open,
  onOpenChange,
  target,
}: ConciliarModalProps): React.ReactElement {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Marque este lançamento como conferido com o extrato bancário. Você
            poderá desfazer mais tarde, se necessário.
          </DialogDescription>
        </DialogHeader>
